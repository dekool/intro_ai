...
def plot_distance_and_expanded_wrt_weight_figure(
    ...
    p1, = ax1.plot(weights, total_cost, label="solution cost")
    ...
    p2, = ax2.plot(weights, total_nr_expanded, color='red', label="#Expanded states")
...
def run_astar_for_weights_in_range(heuristic_type: HeuristicFunctionType, problem: GraphProblem, n: int = 30,
    ...
    costs, expanded, res_weights = [], [], []
    for weight in weights:
        astar = AStar(heuristic_function_type=heuristic_type, heuristic_weight=weight, max_nr_states_to_expand=max_nr_states_to_expand)
    ...
    plot_distance_and_expanded_wrt_weight_figure(problem.name, res_weights, costs, expanded)
...
def toy_map_problem_experiments():
    ...
    astar_res = astar.solve_problem(toy_map_problem)
    print(astar_res)

    # Ex.13
    # TODO: create an instance of `AStar` with the `AirDistHeuristic`,
    #       solve the same `toy_map_problem` with it and print the results (as before).
    astar_air = AStar(AirDistHeuristic)
    astar_air_res = astar_air.solve_problem(toy_map_problem)
    print(astar_air_res)
...
def basic_deliveries_truck_problem_experiments():
    ...
    uniform_cost_solver = UniformCost()
    uniform_small_res = uniform_cost_solver.solve_problem(small_delivery_problem_with_distance_cost)
    print(uniform_small_res)
...
def deliveries_truck_problem_with_astar_experiments():
    ...
    astar_air_truck = AStar(TruckDeliveriesMaxAirDistHeuristic)
    astar_air_truck_res = astar_air_truck.solve_problem(moderate_delivery_problem_with_distance_cost)
    print(astar_air_truck_res)

    # Ex.21
    # TODO: create an instance of `AStar` with the `TruckDeliveriesSumAirDistHeuristic`,
    #       solve the `moderate_delivery_problem_with_distance_cost` with it and print the results.
    astar_sum_air_truck = AStar(TruckDeliveriesSumAirDistHeuristic)
    astar_sum_air_truck_res = astar_sum_air_truck.solve_problem(moderate_delivery_problem_with_distance_cost)
    print(astar_sum_air_truck_res)

    # Ex.24
    # TODO: create an instance of `AStar` with the `TruckDeliveriesMSTAirDistHeuristic`,
    #       solve the `moderate_delivery_problem_with_distance_cost` with it and print the results.
    astar_mst_truck = AStar(TruckDeliveriesMSTAirDistHeuristic)
    astar_mst_truck_res = astar_mst_truck.solve_problem(moderate_delivery_problem_with_distance_cost)
    print(astar_mst_truck_res)
...
def multiple_objectives_deliveries_truck_problem_experiments():
    ...
    astar_mst_truck_time = AStar(TruckDeliveriesMSTAirDistHeuristic)
    astar_mst_truck_time_res = astar_mst_truck_time.solve_problem(small_delivery_problem_with_time_cost)
    print(astar_mst_truck_time_res)

    # Ex.29
    # TODO: create an instance of `AStar` with the `TruckDeliveriesMSTAirDistHeuristic`,
    #       solve the `small_delivery_problem_with_money_cost` with it and print the results.
    astar_mst_truck_money = AStar(TruckDeliveriesMSTAirDistHeuristic)
    astar_mst_truck_money_res = astar_mst_truck_money.solve_problem(small_delivery_problem_with_money_cost)
    print(astar_mst_truck_money_res)
...
def deliveries_truck_problem_with_astar_epsilon_experiments():
    ...
    astar_epsilon = AStarEpsilon(TruckDeliveriesMSTAirDistHeuristic, within_focal_priority_function=within_focal_h_sum_priority_function,focal_epsilon=0.03, max_focal_size=40)
    astar_epsilon_res = astar_epsilon.solve_problem(moderate_delivery_problem_with_distance_cost)
    print(astar_epsilon_res)
...
def deliveries_truck_problem_anytime_astar_experiments():
    ...
    astar_anytime = AnytimeAStar(TruckDeliveriesMSTAirDistHeuristic, max_nr_states_to_expand_per_iteration=50)
    anytime_res = astar_anytime.solve_problem(moderate_delivery_problem_with_distance_cost)
    print(anytime_res)
...
def big_deliveries_truck_problem_with_non_acceptable_heuristic_and_anytime_astar_experiments():
    ...
    astar_anytime_big_sum = AnytimeAStar(TruckDeliveriesSumAirDistHeuristic, max_nr_states_to_expand_per_iteration=400)
    anytime_big_sum_res = astar_anytime_big_sum.solve_problem(big_delivery_problem_with_distance_cost)
    print(anytime_big_sum_res)
    astar_anytime_big_mst = AnytimeAStar(TruckDeliveriesMSTAirDistHeuristic, max_nr_states_to_expand_per_iteration=400)
    anytime_big_mst_res = astar_anytime_big_mst.solve_problem(big_delivery_problem_with_distance_cost)
    print(anytime_big_mst_res)
